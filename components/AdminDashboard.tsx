  ...
  if (!user) {
    return (
      <div className="max-w-md mx-auto p-8 bg-white rounded-2xl shadow-xl text-center border border-gray-200">
        ...
        <button
          onClick={handleLogin}
          className="bg-black text-white px-6 py-3 rounded-lg font-semibold hover:bg-gray-800 transition-colors flex items-center justify-center gap-2 w-full"
        >
          Entrar com Google
        </button>
      </div>
    ...
    return (
      <div className="max-w-md mx-auto p-8 bg-white rounded-2xl shadow-xl text-center border border-red-200">
        ...
        <div className="space-y-4">
          ...
          <button onClick={handleLogout} className="text-gray-500 underline text-sm">Sair da conta</button>
        </div>
      </div>
    );
  }
